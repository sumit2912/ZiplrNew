...
public class ViewModelIdentifier {
    ...
    public static final String KEY_NAVIGATION_MENU_VIEW_MODEL = NavigationMenuViewModel.class.getSimpleName();
    ...
    public static final String DES_NAVIGATION_MENU_VIEW_MODEL = Screen.DASH_BOARD_ACTIVITY;
}
